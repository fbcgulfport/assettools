...
const ASSETBOTS_API_URL = process.env.ASSETBOTS_API_URL || 'https://api.assetbots.com/v1';
const CHECK_MINUTES = parseInt(process.env.CHECK_MINUTES || '1');
...
if (!SMTP_HOST || !SMTP_USER || !SMTP_PASSWORD) {
  console.error('Error: SMTP credentials are required (SMTP_HOST, SMTP_USER, SMTP_PASSWORD)');
  process.exit(1);
}
