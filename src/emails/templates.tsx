		...
		<Body style={{ fontFamily: "Arial, sans-serif", padding: "20px" }}>
			<Container>
				...
				<Section>
					...
					<Text>
						<strong>Checked out to:</strong> {personName}
					</Text>
					<Text>
		...
		<Body style={{ fontFamily: "Arial, sans-serif", padding: "20px" }}>
			<Container>
				...
				<Section>
					...
					<Text>
						<strong>Reserved for:</strong> {personName}
					</Text>
					<Text>
		...
		<Body style={{ fontFamily: "Arial, sans-serif", padding: "20px" }}>
			<Container>
				...
				<Section>
					...
					<Text>
						<strong>
							{itemType === "checkout" ? "Checked out to" : "Reserved for"}:
						</strong>{" "}
						{personName}
					</Text>
					{personEmail && (
					...
					<Text style={{ marginTop: "20px", fontStyle: "italic" }}>
						User confirmation email was NOT sent. Please review and manually
						send if needed.
					</Text>
				</Section>
			</Container>
